...
class StateHandler extends eventHandler {
  ...
  async onMessage(event) {
      ...
      if (config.guildRequirement.enabled) {
        ...
        if (meetRequirements) {
          const statsEmbed = new EmbedBuilder()
            ...
            .setFooter({ text: `Hosted by ooDVG | /help [command] for more information`, iconURL: 'https://imgur.com/tgwQJTX.png' });
    ...
    if (this.isJoinMessage(message)) {
      ...
      await delay(1000)
      bot.chat(`/gc ${messages.guildJoinMessage} | Hosted by ooDVG`)
